...
class upload:
    ...
    def change_column_names(self, doc):
        ...
        entity_rename_dic = {'url':'web', 'expanded_url': 'url_expanded'}
...
########################### !!!Make sure you've filled this section before running (language, keyword, folder_path, path_to_reference, folder_to_keywords)!!!################################################
    ...
    files_you_want_to_upload = ['російський']    # a piece of string, file name: you **WANT** to upload  

    files_done_upload = []      # a piece of string, file name: you **DON'T** want to upload or have done uploading 

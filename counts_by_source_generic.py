...
def count_domain_loc(uri, domain, country_name, country_code):
    ...
    for date in df.index:
        ...
        for et in events:
            ...
            if et == 'legalaction':
                ...
                sub_docs =[doc for doc in docs if doc['civic1']['event_type'] == et]
    ...
    path = f'/home/ml4p/Dropbox/Dropbox/ML for Peace/Counts_Civic/{country_name}/(mordecai){today.year}_{today.month}_{today.day}/'

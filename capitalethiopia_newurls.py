...
for word in keywords:
    ...
    for i in range(1, int(endnumberx)):
        if i == 1:
            url = 'https://www.capitalethiopia.com/category/' + word + '/'
        else:
            url = 'https://www.capitalethiopia.com/category/' + word + '/page/' + str(i) + '/'
...
## URLS from SITEMAP:
for i in range(1, 7):
    url = 'https://www.capitalethiopia.com/post-sitemap' + str(i) + '.xml'
    print("Third Sitemap: ", url)

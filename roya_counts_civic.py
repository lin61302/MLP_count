...
def count_domain_loc(uri, domain, country_name, country_code):
    ...
    path1 = f'/home/ml4p/Dropbox/Dropbox/ML for Peace/Roya_counts/{country_name}/Civic_Related/'
    path2 = f'/home/ml4p/Dropbox/Dropbox/ML for Peace/Roya_counts/{country_name}/Non_Civic_Related/'
